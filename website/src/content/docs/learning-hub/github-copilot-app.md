...
**Quick launch with `copilot app`** (v1.0.81+): If you have the GitHub Copilot CLI installed, the fastest way to open the app in your current directory is:

```bash
copilot app
```

This command opens the GitHub Copilot app and sets the working context to your current directory, bridging your terminal workflow with the desktop app in one step.
