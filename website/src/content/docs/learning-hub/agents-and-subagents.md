...
> **Note (v1.0.74+)**: Multi-turn subagents are always enabled. You can send follow-up messages to a running subagent from `/tasks` without needing to enable any experimental setting.
